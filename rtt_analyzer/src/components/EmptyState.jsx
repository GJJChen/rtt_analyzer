  ...
  return (
    <div className="h-72 md:h-80 flex flex-col items-center justify-center text-center px-4">
      <div className={`mb-4 p-4 md:p-5 rounded-full bg-gradient-to-br ${config.gradient} bg-opacity-10 backdrop-blur-sm`}>
        <Icon size={48} className={`text-transparent bg-gradient-to-br ${config.gradient} bg-clip-text`} strokeWidth={1.5} />
      </div>
      <h3 className="text-lg md:text-xl font-semibold text-gray-700 dark:text-gray-300 mb-1.5">
